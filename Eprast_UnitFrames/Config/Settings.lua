...
C["SetPositions"] = true;				--	[true\false]  - On\Off;	-- Сustom FramePosition [On\Off];
C["Font"] = {"Interface\\AddOns\\"..AddOnName.."\\Media\\Fonts\\PTSansNarrow.ttf", 11, "OUTLINE"};	--	Font;
C["FontName"] = {"Interface\\AddOns\\"..AddOnName.."\\Media\\Fonts\\PTSansNarrow.ttf", 11};	--	Font for Name;
...
-- = PartyFrame = ------------------------------------------------------------------
C["PartyFrameOn"] = false;													--	Enable partyframe mod [true/false];
